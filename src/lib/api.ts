    ...
    async (error: AxiosError<ApiError>) => {
        ...
        if (error.response) {
            ...
            if (detailObj?.error_category) {
                (customError as ApiError & { error_category?: string }).error_category = String(
                    detailObj.error_category
                );
            }
 ...
 */
export const getEvaluationMetrics = async (options?: {
    signal?: AbortSignal;
 ...
 */
export const getIngestTrace = async (ingestId: string): Promise<PipelineTrace> => {
    const response = await apiClient.get<PipelineTrace>(`/api/v1/ingest/${ingestId}/trace`);
    return response.data;
};
 ...
 */
export const processAccounting = async (ingestId: string): Promise<ProcessResponse> => {
    try {
 ...
 */
export const getProcessResult = async (processId: string): Promise<ProcessResultResponse> => {
 ...
 */
export const getProcessTrace = async (processId: string): Promise<PipelineTrace> => {
    const response = await apiClient.get<PipelineTrace>(`/api/v1/process/${processId}/trace`);
    return response.data;
};
/**
 ...
 */
export const getBalanceGeneral = async (fecha_fin?: string): Promise<BalanceGeneralEntry[]> => {
 ...
 * Retrieves monthly ingresos vs gastos for the last N months.
 */
export const getMonthlyTrend = async (
    company_nit?: string,
    months = 6
): Promise<MonthlyTrendResponse> => {
    const response = await apiClient.get<MonthlyTrendResponse>('/api/v1/dashboard/monthly-trend', {
 ...
 */
export const getCompanySettings = async (nit: string): Promise<CompanySettingsResponse | null> => {
    try {
 ...
 */
export const updatePuc = async (codigo: string, payload: CuentaPUCRequest): Promise<CuentaPUC> => {
    const response = await apiClient.put<CuentaPUC>(`/api/v1/puc/${codigo}`, payload);
    return response.data;
};
 ...
 */
export const getStatement = async (statementId: string): Promise<FinancialStatementResponse> => {
    const response = await apiClient.get<FinancialStatementResponse>(
 ...
 */
export const getDeclarationDraft = async (draftId: string): Promise<TaxDeclarationDraft> => {
...
export const getTaxCalendar = async (
    ...
    const response = await apiClient.get<TaxCalendarResponse>('/api/v1/tax/calendar', { params });
    return response.data;
};
...
export const generateF220Certificates = async (
    ...
    const response = await apiClient.post<F220Response>('/api/v1/tax/certificates/f220', null, {
...
export const getExogenaFormat = async (
    ...
    const response = await apiClient.get<ExogenaResponse>(`/api/v1/tax/exogena/${formato}`, {
        params: { company_nit: companyNit, year },
    });
    return response.data;
};
 ...
 */
export const getChatSessions = async (companyNit?: string): Promise<ChatSessionSummary[]> => {
 ...
 */
export const getChatMessages = async (sessionId: string): Promise<ChatMessageRecord[]> => {
