...
export function useChat(companyNit?: string) {
                        ...
                        if (line.startsWith('data: ')) {
                            try {
                                ...
                                if (data.content !== undefined) {
                                    ...
                                    reasoningSteps = [
                                        ...reasoningSteps,
                                        data.thinking as ChatReasoningStep,
                                    ];
                ...
                if (err instanceof Error && err.name === 'AbortError') {
                    ...
                    setMessages((prev) => {
                        ...
                        updated[updated.length - 1] = {
                            ...
                            role: 'assistant',
                            content:
                                'Error al comunicarse con el servidor. Verifica que el backend esté corriendo.',
                        };
                        return updated;
                    });
                }
    ...
    const removeSession = useMutation({
        mutationFn: (id: string) => chatApiClient.deleteChatSession(id),
